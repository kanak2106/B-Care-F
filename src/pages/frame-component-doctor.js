            ...
            <div className="absolute top-[47.19rem] left-[0rem] w-[88.56rem] h-[51.25rem] text-[1.25rem] text-light-background-color font-dm-serif-display">
                <div className="absolute top-[0rem] left-[0rem] w-[88.56rem] h-[51.25rem]">
                    <div className="absolute top-[0rem] left-[0rem] w-[90rem] h-[47.06rem]">
                        ...
                        <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[17.38rem] left-[10.15rem] text-[1rem] leading-[1.25rem] font-medium font-poppins text-light-background-color text-center inline-block w-[2.83rem] h-[1.09rem]">
                ...
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[31rem] left-[10.15rem] text-[1rem] leading-[1.25rem] font-medium font-poppins text-light-background-color text-center inline-block w-[2.83rem] h-[1.09rem]">
                    <span className="tracking-[0.1em]">V</span>
                    <span className="tracking-[0.2em]">isit</span>
                </button>
                <img
